...
import mrfinger.gothicgamemod.client.model.ModelGiantRat;
...
import mrfinger.gothicgamemod.entity.effect.EntityFireBolt;
...
public class GGMRenderers {
	...
	{
		RenderingRegistry.registerEntityRenderingHandler(EntityScavenger.class, new RenderGGMAnimal(new ModelScavenger(), "scavenger.png", 0.6F));
		RenderingRegistry.registerEntityRenderingHandler(EntityNikita.class, new RenderGGMAnimal(new NikitaModel(), "nikita.png", 1.0F));
		RenderingRegistry.registerEntityRenderingHandler(EntityGiantRat.class, new RenderGGMAnimal(new ModelGiantRat(), "giantrat.png", 0.5F));
	}
