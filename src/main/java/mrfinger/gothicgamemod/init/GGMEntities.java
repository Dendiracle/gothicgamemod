...
public class GGMEntities
{
	...
	public static int EXPFromLvlModifier = 10;
	...
	private static void loadHostileMobs()
	{
		...
		registerEntity(EntityGiantRat.class, "GiantRat", 0x00FFFF, 0x07008B);
	...
	public static void registerAnimal(Class<? extends EntityGothicAnimalOld> entityClass, String name, int primaryColor, int secondaryColor)
	{
