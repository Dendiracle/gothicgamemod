...
public class HabitatsCollection extends WorldSavedData
{
    ...
    {
        return this.findRightPack(entity.getFraction(), entity.getPosX(), entity.getPosY(), entity.getPosZ());
    }
    ...
    public IPackEntity findRightPack(PackFraction fraction, double posX, double posY, double posZ)
    {
        ...
        pack.setSize(fraction.getSimplePackRange(), fraction.getSimplePackHeight());
        return pack;
    }
    ...
    public void readFromNBT(NBTTagCompound compound)
    {
        ...
        System.out.println("Debug in HabitatsCollection readnbt " + world);
    ...
    public void writeToNBT(NBTTagCompound compound)
    {
        ...
        System.out.println("Debug in HabitatsCollection savenbt");
