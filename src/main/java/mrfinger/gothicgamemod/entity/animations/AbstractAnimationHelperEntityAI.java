...
public abstract class AbstractAnimationHelperEntityAI<Entity extends IGGMEntityLivingBase, Episode extends IAnimationEpisode> extends EntityAIBase implements IAnimationHelper<Entity, Episode>
{
    ...
    public AbstractAnimationHelperEntityAI()
    {
        this(null);
    }

    public AbstractAnimationHelperEntityAI(Entity entity)
    {
        this.entity = entity;
    }
    ...
    {
        return "AnimationHelperEntityAI:" + this.getUnlocalizedName();
    }
