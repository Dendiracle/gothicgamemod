...
public abstract class EntityGothicAnimal extends EntityMob {
	...
	public static final List<EntityGothicAnimal.AnimalsPack> animalPacksList = new LinkedList<EntityGothicAnimal.AnimalsPack>();
	...
	public static void onUpdatePacks() {
		...
		if (GGMTicks.getGTicks() % 20 == 0) {
			...
			for(AnimalsPack pack : EntityGothicAnimal.animalPacksList) {
				pack.everySecUpdate();
			}
		}
	...
	public static EntityGothicAnimal.AnimalsPack getClosestPack(Entity entity) {
	...
	protected class AnimalsPack {
		...
		List<EntityGothicAnimal>	animalsList;
		...
		AnimalsPack(World world, Fraction fraction, double x, double y, double z) {
			...
			EntityGothicAnimal.animalPacksList.add(this);
		}
		...
		void everySecUpdate() {
			...
			if (this.aggr) {
				for (EntityGothicAnimal entity : this.animalsList) {
		...
		protected void findEntityToAttack() {
			...
			List<EntityGothicAnimal> list2 = this.animalsList;
		...
		boolean checkVisionable(Entity entity) {
			for (EntityGothicAnimal gEntity : this.animalsList) {
