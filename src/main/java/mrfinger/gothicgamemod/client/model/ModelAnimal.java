...
public abstract class ModelAnimal extends ModelBase
{
	...
	public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity entity)
	{
		...
		if (entity instanceof IGGMEntityLivingBase)((IGGMEntityLivingBase) entity).getCurrentAnimation().modifyModel(this, p_78087_1_, p_78087_2_, ((IGGMMinecraft) Minecraft.getMinecraft()).getTimer().renderPartialTicks);
	}
