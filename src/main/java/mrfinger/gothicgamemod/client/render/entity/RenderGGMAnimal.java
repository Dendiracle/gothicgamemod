	...
	protected void renderModel(EntityLivingBase entity, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float size)
    {
        ...
        if (!entity.isInvisible())
        {
            if (entity.width != ((IEntityGothicAnimal) entity).getStandartWidth())
            {
                ...
                GL11.glPushMatrix();
                float f1 = size * (24F - this.modelAnimal.corpusHeight() - (((24F - this.modelAnimal.corpusHeight()) * entity.width) / ((IEntityGothicAnimal) entity).getStandartWidth()));//(24F - this.modelAnimal.corpusHeight()) * (1F - f0) * size;
                //System.out.println("Debug in RenderANimal " + size + " " + modelAnimal.corpusHeight() + " " + entity.width + " " + ((IEntityGothicAnimal) entity).getStandartWidth() + " " + f1);
