	...
	public void renderOverlay(RenderGameOverlayEvent re) {
		...
		if (re.type.equals(ElementType.TEXT)) {
			...
			if (mc.playerController.gameIsSurvivalOrAdventure()) {
				...
				float playerHealth = (float) player.getHealthAttribute().getCurrentValue();
				float playerStamina = (float) player.getStaminaAttribute().getCurrentValue();
				float playerMana = (float) player.getManaAttribute().getCurrentValue();
